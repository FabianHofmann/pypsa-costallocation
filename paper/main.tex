...
\end{figure*}
The peer-to-peer cost allocation suits for any type of topology or network setup. In the following we showcase a two bus system with one optimized time step, shown in \cref{fig:example_network} and its resulting allocated payments. \\
The two buses are connected via a transmission line and both have generators. Whereas the generator at bus 1 has an operational price of 50 \euro/\megawatthour, the generator at bus 2 has a higher operational price of 200 \euro/\megawatthour. Both generators have the same CAPEX rate of 500 \euro/MW and both are constraint to a maxmimal capacity of $\capacityGenerationUpper$ = 100 MW. The transmission line has a CAPEX rate of 100 \euro/MW and no upper capacity limit. With a demand of 60 MW at bus 1 and 90 MW at bus 2, the optimization  deploys the generator at bus 1 with its full limit of 100 MW. The 40\,MW excess power not consumed at bus 1, flow to bus 2 where the generator is only built with 50 MW.   
