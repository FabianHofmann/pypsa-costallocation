...
\twocolumn[
  \begin{@twocolumnfalse}
    ...
    \begin{abstract}
        Cost minimization is a common approach in energy system modelling. In long-term studies, it leads to perfectly scheduled operations and investments while securing all power demands. System needs reports from regional, national and international agencies increasingly rely on cost minization techniques. However, cost impact to single regions and thefore the question of who profits to what extent from an investment is often neglected. 
        This work introduces a peer-to-peer cost allocation for cost-minimized system models. It is based on two basic principal. The first being that in a long-term equilibrium the expenses occasioned by a network asset can be expressed as a function of its operation. The second is that using flow allocation techniques, the operationel state can be allocated to consumers. 
        The cost allocation reflects the behaviour of the optimized Locational Marginal Prices while allocating costs in a plausible and spatially constraint manner. It is showcased by means of an optimized German power system with an carbon tax of 120 \euro\, per tonne CO$_2$. 
        % Applying it to an optimized German with a carbon tax of 120 \euro\, per tonne CO$_2$, network shows that transmission and backup investments capacity drive the prices for regions remote from   
        % This opens the possibility to transparently integrate transmission constraints and investment costs in system development plans and possibly into the power market. 
        \vtop{%
         \vskip0pt
          \hbox{%
