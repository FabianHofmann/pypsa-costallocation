...
\begin{figure*}
    ...
    \caption{Duration curve of the CAPEX allocation for production and storage technologies. Hours are sorted such that the total amount of allocated expenditure per hour decreases. With 2.7 bn~\euro\, the first value pushes investments extraordinary high. It is dominated by CAPEX for OCGT to which 92\% of the payments are allocated. This hour alone occasions about half of all OCGT CAPEX. The remaining time-steps are dominated by revenues for onshore wind.}
