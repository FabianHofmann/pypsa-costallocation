...
% Let $\cost_{i}$ denote an arbitrary cost term associated with asset $i$.  %As we will show later the composition of $\mu_{i,t}$ must be determined for each type of asset individually.
